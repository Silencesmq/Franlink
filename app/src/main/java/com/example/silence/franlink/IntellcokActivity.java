...
public class IntellcokActivity extends BaseActivity {

    private final String TAG = "IntellcokActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intellock);
    ...
    private void initfingerprintManager() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(IntellcokActivity.this, "Fingerprint init failed! Try again!", Toast.LENGTH_SHORT).show();
        }
    }
